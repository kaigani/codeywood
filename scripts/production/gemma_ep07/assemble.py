#!/usr/bin/env python3
"""
Assemble EP07 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP07 — THE CLIMB (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP07_the_climb.mp4"
