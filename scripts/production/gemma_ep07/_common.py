"""Common config for gemma-anthology EP07 production scripts.

EP07 = "The Climb" — rough-cut tier (pure t2v, no refs). Amber transit
tunnel. Sodium-amber + bruised purples + deep blacks.
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP07"
SHOTLIST = PROJECT / "shotlists" / "episode-07.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP07"
...
STYLE_TAG = (
    "Cinematic live-action frame, gritty industrial cyberpunk aesthetic, shot "
    "on 35mm film with heavy grain and high contrast, claustrophobic handheld "
    "camera with shallow depth of field, sodium-amber and bruised-purple and "
    "deep-black color palette, flickering amber sodium lamps overhead, ribbed "
    "rusted conduits weeping condensation, narrow transit tunnel walls, "
    "naturalistic skin texture with visible grime and sweat. Photoreal "
    "cinematic photography, NOT animation."
)
