#!/usr/bin/env python3
"""
Generate EP10 rough-cut LTX-2.3 clips with NO references —
pure text-to-video, native audio. 13 shots total.
"""
...
WORKFLOW = "ltx2-3"
SEED_BASE = 81600  # EP10 seed range
...
def main():
    ...
    print("=" * 70)
    print(f"EP10 ROUGH CUT — {WORKFLOW} t2v — {len(shots)} shots — total {total_dur}s")
    print("=" * 70)
