#!/usr/bin/env python3
"""
Assemble EP10 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP10 — THE RELEASE (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP10_the_release.mp4"
