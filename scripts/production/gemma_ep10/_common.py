"""Common config for gemma-anthology EP10 production scripts.

EP10 = "The Release" — rough-cut tier (pure t2v, no refs). Cathedral of
meat and metal. Bruised purple + sickly amber + obsidian black.
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP10"
SHOTLIST = PROJECT / "shotlists" / "episode-10.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP10"
...
NEGATIVE = (
    ...
    "duplicate figures, daylight, bright, cheerful"
)

STYLE_TAG = (
    "Cinematic live-action frame, high-contrast cyberpunk noir aesthetic, "
    "shot on 35mm anamorphic lenses with heavy grain, slow gliding camera "
    "movements contrasted with sudden jarring handheld cuts, bruised "
    "purple and sickly amber and obsidian black color palette, deep "
    "shadows with sharp rim-lighting on cybernetic grafts, polished black "
    "obsidian floor reflecting flickering amber neon, wet organic cables "
    "hanging from the ceiling. Photoreal cinematic photography, NOT "
    "animation."
)
