#!/usr/bin/env python3
"""
Assemble EP05 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP05 — THE LEAK (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP05_the_leak.mp4"
