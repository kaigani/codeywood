"""Common config for gemma-anthology EP05 production scripts.

EP05 = "The Leak" — rough-cut tier (pure t2v, no refs). Sump District
alleyways. Bile-green + bruised purple + oxidized copper.
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP05"
SHOTLIST = PROJECT / "shotlists" / "episode-05.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP05"
...
STYLE_TAG = (
    "Cinematic live-action frame, cyber-grunge aesthetic, shot on 35mm "
    "anamorphic lens with heavy film grain, handheld visceral camera "
    "movement, sickly bile-green and bruised purple shadows with oxidized "
    "copper and flickering cyan neon highlights and warm amber sodium "
    "lamps, high contrast deep shadows and blown-out neon, naturalistic "
    "skin texture, yellow smog atmosphere, dripping pipes and wet "
    "corrugated metal. Photoreal cinematic photography, NOT animation."
)
