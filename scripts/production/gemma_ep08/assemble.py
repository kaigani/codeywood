#!/usr/bin/env python3
"""
Assemble EP08 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP08 — THE ESTATE (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP08_the_estate.mp4"
