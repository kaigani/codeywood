"""Common config for gemma-anthology EP08 production scripts.

EP08 = "The Estate" — rough-cut tier (pure t2v, no refs). Citadel of
Samleif Fast. White marble + brushed steel + bruised purples.
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP08"
SHOTLIST = PROJECT / "shotlists" / "episode-08.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP08"
...
NEGATIVE = (
    ...
    "duplicate figures, warm, golden, cozy, dirty walls"
)

STYLE_TAG = (
    "Hyper-realistic 8K cinematic live-action frame, brutalist cyberpunk "
    "sanctuary aesthetic, shot on 35mm with high contrast and desaturated "
    "palette, slow mechanical precise camera mimicking a robotic gaze, "
    "shallow depth of field, white marble and brushed steel and bruised "
    "purple color palette, sterile cold high-contrast lighting with deep "
    "blue shadows, polished surfaces reflecting cold light, naturalistic "
    "skin texture against immaculate architecture. Photoreal cinematic "
    "photography, NOT animation."
)
