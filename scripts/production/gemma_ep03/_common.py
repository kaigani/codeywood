"""Common config and helpers for gemma-anthology EP03 production scripts.

EP03 = "The Sump" — rough-cut test, pure t2v LTX-2.3 with NO references
(no character refs, no location refs, no qwen composite frames, no voice
refs). Each shot is generated solely from prompt text. Native audio.
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP03"
SHOTLIST = PROJECT / "shotlists" / "episode-03.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP03"

# Cyberpunk-noir wet-texture negative for EP03's sump aesthetic.
NEGATIVE = (
    ...
    "duplicate figures, clean, bright, dry, sterile"
)

# Cyberpunk-noir wet-texture style — 35mm anamorphic, bruised purples,
# neon cyan, sickly ochre, heavy grain, handheld.
STYLE_TAG = (
    "Cinematic live-action frame, shot on 35mm anamorphic lens with heavy "
    "film grain, handheld camera with subtle instability, cyberpunk-noir "
    "wet texture, bruised purple shadows with neon cyan and sickly ochre "
    "highlights, high contrast deep shadows and blown highlights, "
    "naturalistic skin texture, practical lighting from flickering pink and "
    "cyan fluorescent tubes, claustrophobic basement atmosphere. "
