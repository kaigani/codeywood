"""Common config and helpers for gemma-anthology EP04 production scripts.

EP04 = "The Price" — rough-cut tier (pure t2v, no refs), Koffey's
appraisal vault. Amber + bile-green palette (distinct from EP03's
pink/cyan sump corridor).
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP04"
SHOTLIST = PROJECT / "shotlists" / "episode-04.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP04"

# Cyber-noir biological-edge negative.
NEGATIVE = (
...
# Amber + bile-green appraisal-vault style — 35mm, heavy grain, handheld,
# high contrast, surgical lamp pool of light.
STYLE_TAG = (
    "Cinematic live-action frame, shot on 35mm film with heavy film grain, "
    "handheld camera with subtle instability, cyber-noir biological edge, "
    "sickly amber and bile-green color grade with deep saturated shadows "
    "and blown-out highlights, naturalistic skin texture, practical lighting "
    "from flickering amber neon tubes and a single high-intensity surgical "
    "lamp pool, close-up textures of slime, rusted metal, and peeling skin, "
    "damp subterranean chamber atmosphere. "
