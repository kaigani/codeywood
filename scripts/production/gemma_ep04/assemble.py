#!/usr/bin/env python3
"""
Assemble EP04 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP04 — THE PRICE (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP04_the_price.mp4"
