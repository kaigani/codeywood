#!/usr/bin/env python3
"""
Generate EP09 rough-cut LTX-2.3 clips with NO references —
...
WORKFLOW = "ltx2-3"
SEED_BASE = 81500  # EP09 seed range
...
def main():
    ...
    print("=" * 70)
    print(f"EP09 ROUGH CUT — {WORKFLOW} t2v — {len(shots)} shots — total {total_dur}s")
    print("=" * 70)
