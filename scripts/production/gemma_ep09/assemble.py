#!/usr/bin/env python3
"""
Assemble EP09 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP09 — THE SLAUGHTER (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP09_the_slaughter.mp4"
