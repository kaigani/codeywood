"""Common config for gemma-anthology EP06 production scripts.

EP06 = "The Conversion" — rough-cut tier (pure t2v, no refs). Subterranean
conversion clinic. Bile-green + sterile-white + deep charcoal.
"""
...
PRODUCTION = PROJECT / "PRODUCTION" / "EP06"
SHOTLIST = PROJECT / "shotlists" / "episode-06.md"
CLIP_DEFS = PRODUCTION / "clip_definitions.yaml"

CLIPS_DIR = PRODUCTION / "clips"
ASSEMBLY_DIR = PRODUCTION / "assembly"
DELIVERABLES = PROJECT / "DELIVERABLES" / "EP06"
...
STYLE_TAG = (
    "Cinematic live-action frame, industrial cyberpunk aesthetic, shot on "
    "35mm film with heavy grain and high contrast, clinical precise camera "
    "with slow dollies and sudden jarring handheld shakes, bile-green and "
    "sterile-white and deep-charcoal color palette, sickly green fluorescent "
    "tubes overhead, chrome surgical arms hanging from the ceiling, damp "
    "concrete walls stained with yellow chemical runoff, naturalistic skin "
    "texture, shallow depth of field. Photoreal cinematic photography, NOT "
    "animation."
)
