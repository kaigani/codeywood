#!/usr/bin/env python3
"""
Generate EP06 rough-cut LTX-2.3 clips with NO references —
...
WORKFLOW = "ltx2-3"
SEED_BASE = 81200  # EP06 seed range
...
def main():
    ...
    print("=" * 70)
    print(f"EP06 ROUGH CUT — {WORKFLOW} t2v — {len(shots)} shots — total {total_dur}s")
    print("=" * 70)
