#!/usr/bin/env python3
"""
Assemble EP06 — normalize each clip then concat (re-encode, never stream-copy).
"""
...
def main():
    ...
    print("=" * 70)
    print("ASSEMBLE EP06 — THE CONVERSION (rough cut, t2v native)")
    print("=" * 70)
    ...
    final_out = DELIVERABLES / "EP06_the_conversion.mp4"
