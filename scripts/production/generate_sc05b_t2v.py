#!/usr/bin/env python3
"""
Generate LTX-2 text-to-video clips for SC05b — Air Pocket: The Ledger Speaks.
...
SCENE_DIR = PROJECT_ROOT / "PRODUCTION" / "EP01" / "sc05b"
...
NEGATIVE_PROMPT = (
    ...
    "text, watermark, modern clothing, bright lighting, daylight, sunlight"
)
...
def main():
    ...
    print(f"Generating {total} LTX-2 t2v clips for SC05b")
